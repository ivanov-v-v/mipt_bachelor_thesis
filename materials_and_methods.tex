...
\begin{equation}
	\mathtt{L}(q) = \int{ q(\Omega) \log p(\bm{AD}, \bm{DP}, \bm{RD}\ |\ \Omega)} \text{d} \Omega -\mathcal{KL}(q(\Omega)\ \|\ p(\Omega))
\end{equation}
